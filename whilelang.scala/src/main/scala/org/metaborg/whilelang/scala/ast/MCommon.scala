...
object MCommon {
  ...
  case class SID(string: java.lang.String)(val origin: scalaterms.Origin) extends sdf.Lexical {
    override def toSTerm: STerm.String = STerm.String(string, scala.Some(origin))
  }
  // Define implicit conversions (e.g. in the package object) to another representation you prefer
  case class SINT(string: java.lang.String)(val origin: scalaterms.Origin) extends sdf.Lexical {
    override def toSTerm: STerm.String = STerm.String(string, scala.Some(origin))
  }
  // Define implicit conversions (e.g. in the package object) to another representation you prefer
  case class SSTRING(string: java.lang.String)(val origin: scalaterms.Origin) extends sdf.Lexical {
    override def toSTerm: STerm.String = STerm.String(string, scala.Some(origin))
  }
  // Define implicit conversions (e.g. in the package object) to another representation you prefer
  case class SStringChar(string: java.lang.String)(val origin: scalaterms.Origin) extends sdf.Lexical {
    override def toSTerm: STerm.String = STerm.String(string, scala.Some(origin))
  }
  // Define implicit conversions (e.g. in the package object) to another representation you prefer
  case class SBackSlashChar(string: java.lang.String)(val origin: scalaterms.Origin) extends sdf.Lexical {
    override def toSTerm: STerm.String = STerm.String(string, scala.Some(origin))
  }
  // Define implicit conversions (e.g. in the package object) to another representation you prefer
  case class SCommentChar(string: java.lang.String)(val origin: scalaterms.Origin) extends sdf.Lexical {
    override def toSTerm: STerm.String = STerm.String(string, scala.Some(origin))
  }
  // Define implicit conversions (e.g. in the package object) to another representation you prefer
  case class SInsideComment(string: java.lang.String)(val origin: scalaterms.Origin) extends sdf.Lexical {
    override def toSTerm: STerm.String = STerm.String(string, scala.Some(origin))
  }
  // Define implicit conversions (e.g. in the package object) to another representation you prefer
  case class SNewLineEOF(string: java.lang.String)(val origin: scalaterms.Origin) extends sdf.Lexical {
    override def toSTerm: STerm.String = STerm.String(string, scala.Some(origin))
  }
  // Define implicit conversions (e.g. in the package object) to another representation you prefer
  case class SEOF(string: java.lang.String)(val origin: scalaterms.Origin) extends sdf.Lexical {
    override def toSTerm: STerm.String = STerm.String(string, scala.Some(origin))
  }
  // Lexical extractors
